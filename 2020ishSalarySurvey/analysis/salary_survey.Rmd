...
* 60% of respondents worked somewhere that provided additional benefits due to the COVID-19 pandemic.

* 26% respondents work in a unionized workplace or have a recognized bargaining unit.

* Among respondents who work in a unionized workplace or have a recognized bargaining unit, a large plurality (47%) work someplace that has unionized within the past two years. 
...
plot_salary(df, var) + scale_colour_viridis_d(option = "A") + theme_minimal() 
```
...
plot_salary(df, var) + theme_minimal() 
```
