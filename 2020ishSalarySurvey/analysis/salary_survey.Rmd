...
[Only asked to respondents who attempted a negotiation. Trans or Nonbinary reported for all races because of small n-sizes.]
```{r, message = FALSE, echo = FALSE }

df <- df %>% 
  mutate(
    gender_race2 = case_when(
      gender_race %in% c(
        "White | Trans or Nonbinary", 
        "POC/Other | Trans or Nonbinary" 
      ) ~ "Any Race | Trans or Nonbinary", 
     TRUE ~ gender_race)
    ) 
