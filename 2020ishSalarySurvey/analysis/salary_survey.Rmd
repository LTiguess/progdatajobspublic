...
author: "Mahelet Fekade, Lena Tom, Cristina Sinclaire, Amit Mistry, and Olivia Robinson"
date: "5/3/2021"
output:
  html_document:
    df_print: paged
...
plot_salary(df, var) + 
  ...
  theme_minimal() + 
  labs(color = "Gender") + 
  scale_color_manual(values = c("#DD513AFF", "#440154FF"))
```

### Gender (Binned)

```{r, message = FALSE, echo = FALSE }
var <- substitute(gender_cis)
...
plot_salary(df, var) + theme_minimal()  +  labs(color = "Gender") + 
  scale_color_manual(values = c("#DD513AFF", "#440154FF"))
```
...
plot_salary(df, var) + theme_minimal() +  labs(color = "Race / Ethnicity") + 
  scale_color_manual(values = c("#F7D340FF", "#5C126EFF"))
```
...
## Date of Unionization{#union_date}
...
cat_cross(x = df, 
  ...
  last_ord = NULL
   ...
   mutate( `All\n(n = 608)`  = color_bar("lightgray")( `All\n(n = 608)`), 
           `Cis man\n(n = 259)` =  color_bar("lightgray")( `Cis man\n(n = 259)`), 
            `Non-Cis man\n(n = 341)`  = color_bar("lightgray")(`Non-Cis man\n(n = 341)`)) %>%
...
mult_resp_cross(
  ...
  mutate(
    response_name = factor(response_name,
                      levels = c("Yes, I increased my benefits", "Yes, I increased my compensation", 
                                 "Yes, I improved my title" , "No, I did not gain improved compensation, benefits or title")))  %>% 
      arrange(response_name)  %>% 
    
  # add some nice formatting 
      mutate( `All\n(n = 219)`  = color_bar("lightgray")( `All\n(n = 219)`), 
           `Cis man\n(n = 92)` =  color_bar("lightgray")( `Cis man\n(n = 92)`), 
            `Non-Cis man\n(n = 124)`  = color_bar("lightgray")(`Non-Cis man\n(n = 124)`))  %>% 
...
cat_cross(x = df, 
  ...
  mutate(
     `All\n(n = 608)` = color_bar("lightgray")(`All\n(n = 608)`),
     `POC/Other\n(n = 212)` = color_bar("lightgray")(`POC/Other\n(n = 212)`),
      `White\n(n = 390)` = color_bar("lightgray")( `White\n(n = 390)`)
  ) %>%
      rename(' ' = question) %>%
       kable("html", escape = F, booktabs = T, align = "lrrrr") %>%
      kable_styling("hover")  
```
...
mult_resp_cross(
  ...
  # add some nice formatting 
   mutate(
     `All\n(n = 219)` = color_bar("lightgray")(`All\n(n = 219)`),
     `POC/Other\n(n = 85)` = color_bar("lightgray")(`POC/Other\n(n = 85)`),
      `White\n(n = 133)` = color_bar("lightgray")( `White\n(n = 133)`)) %>%
      rename(' ' = response_name) %>%
       kable("html", escape = F, booktabs = T, align = "lrrrr") %>%
      kable_styling("hover")  
...
cat_cross(x = df, 
  ...
  last_ord = NULL
   ...
   mutate(
      `All\n(n = 608)` = color_bar("lightgray")(`All\n(n = 608)`),
     `POC/Other | Cis man\n(n = 85)` = color_bar("lightgray")( `POC/Other | Cis man\n(n = 85)`),
      `POC/Other | Non-Cis man\n(n = 126)` = color_bar("lightgray")( `POC/Other | Non-Cis man\n(n = 126)`),
     `White | Cis man\n(n = 173)` = color_bar("lightgray")( `White | Cis man\n(n = 173)`), 
      `White | Non-Cis man\n(n = 214)` = color_bar("lightgray")( `White | Non-Cis man\n(n = 214)`)) %>%
      rename(' ' = question) %>%
       kable("html", escape = F, booktabs = T, align = "lrrrr") %>%
      kable_styling("hover")  
...
mult_resp_cross( x = df %>% # remove people who didn't answer yes to the previous question
  ...
  mutate(
   ...
   mutate(
      `All\n(n = 219)` = color_bar("lightgray")(`All\n(n = 219)`),
     `POC/Other | Cis man\n(n = 37)` = color_bar("lightgray")( `POC/Other | Cis man\n(n = 37)`),
      `POC/Other | Non-Cis man\n(n = 48)` = color_bar("lightgray")( `POC/Other | Non-Cis man\n(n = 48)`),
     `White | Cis man\n(n = 55)` = color_bar("lightgray")( `White | Cis man\n(n = 55)`), 
      `White | Non-Cis man\n(n = 76)` = color_bar("lightgray")( `White | Non-Cis man\n(n = 76)`)) %>%
      rename(' ' = response_name) %>%
       kable("html", escape = F, booktabs = T, align = "lrrrr") %>%
      kable_styling("hover")  
